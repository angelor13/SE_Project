...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
	  Motor_Set_Direction(0x01); // Set direction forward
	      Motor_Set_Speed(PWM_PERIOD / 2); // Set speed to 50%
	      HAL_Delay(1000); // Delay for 1 second


	      Motor_Set_Direction(0x02); // Set direction reverse
	       Motor_Set_Speed((uint16_t)(PWM_PERIOD * 0.75)); // Set speed to 75%
