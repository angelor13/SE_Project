 ...
 ******************************************************************************
 * Version History:                                                           *
 *  Version 0.1: getDistanceRaw, getDistanceVolt, getDistanceCentimeter       *
 *                (with LUT based on datasheet)                               *
 ...
 *  Version 0.6: Compare different sensors, calculate replacement LUT         *
 *               (at runtime) based on calibration points                     *
 ******************************************************************************
